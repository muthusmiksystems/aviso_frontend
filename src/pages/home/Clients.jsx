  ...
  <footer className="bg-[#ffff] py-8  mx-auto font-[OmnesArabic]">
    <div className="text-center w-auto  max-w-4xl mx-auto">
      <p className="text-[#000000] text-[20px] md:text-xl font-semibold">
        TRUSTED BY THE WORLD'S <span className="text-[#24A1DD]">BIGGEST EDUCATIONAL INSTITUTES</span>
      </p>
      <div className="flex justify-between mt-6 px-4 md:px-6 place-items-center">
        ...
        <Img src={Images.Client5} alt="Client 5" className="w-24 md:w-64 h-auto" />
      </div>
    </div>
  </footer>
);
