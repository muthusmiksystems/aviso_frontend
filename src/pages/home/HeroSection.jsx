...
const HeroSection = () => {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center  py-12 text-center fonts-[OmnesArabic] bg-gradient-to-r from-[#fffff] via-[#F7F8FE] to-[#F0F0FC] ">
            {/* Background Image */}
            <Img
            ...
            {/* Heading */}
            <h1 className="text-xl sm:text-3xl md:text-5xl  w-auto  max-w-4xl text-wrap font-[OmnesArabic] font-bold ">
            ...
            <div className="relative mt-8 flex w-[90%] sm:w-[70%] max-w-2xl items-center rounded-full border border-blue-400 bg-white px-7 py-0 md:py-1 shadow-md">
                ...
                <div className="w-full">
                    <Input
                        ...
                        className="flex-1 px-6 py-0 text-gray-600 focus:outline-none"
                    />
                ...
                <div className="flex align-end">
                    <button className=" bg-blue-500 text-white px-3 md:px-8 py-2 md:py-2.5 rounded-full text-sm hover:bg-blue-600 sm:px-4">
                        Search
                    </button>
                </div>
            </div>
