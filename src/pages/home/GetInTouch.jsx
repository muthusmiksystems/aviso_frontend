...
function GetInTouch() {
    return (
        <div className='px-5 py-6 mt-16 md:px-12 md:py-10 font-[OmnesArabic]'>
            <div className='bg-[#25A1DD] rounded-3xl'>
                <div className='grid grid-cols-1 md:grid-cols-2 '>
                    <div className='hidden md:block'>
                        <Img src={Images.GetTouch} alt="getintouch" className="h-full" />
                    </div>
                    <div className=' py-14  pl-8 pr-14' >
                        <h2 className="text-3xl md:text-[55px] text-white font-bold mb-5">Get in Touch</h2>
                        <p className="mt-2 text-white text-2xl font-semibold mb-16">
