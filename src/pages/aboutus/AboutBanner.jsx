...
const AboutBanner = () => {
  return (
    ...
    className="text-white py-16 px-6 md:px-12 lg:px-20 flex flex-col md:flex-row items-center justify-between h-[352px] font-[OmnesArabic]">
      ...
      <div className="md:w-1/2 mt-8 md:mt-0 flex justify-end">
        <img 
          ...
          className="w-full max-w-[550px] h-auto md:h-[390px] mt-38"
        />
      </div>
