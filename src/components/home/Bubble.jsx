        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative pb-24 h-auto">
            ...
            <div className="absolute hidden lg:block inset-0 z-0">
                ...
                <img
                    ...
                    width={150}
                    height={10}
                    className="absolute top-1/6 right-[21%] transform "
                    style={{ transformOrigin: "right center" }}
                />
                {/* Yellow dot */}
                <div className="absolute xxl:top-[33%] xl:top-[35%] lg:top-[36%] right-[26%] w-8 h-8 rounded-full bg-yellow-300 -translate-x-1/2 -translate-y-1/2"></div>
            </div>
