        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative pb-34 h-auto ">
            <div className="absolute hidden lg:block inset-0 z-0">
                ...
                <img
                    ...
                    // width={150}
                    height={10}
                    className="absolute top-[25%] left-[19.2%] w-[13%] transform -translate-y-1/2"
                />
                ...
                <img
                    ...
                    // width={160}
                    height={10}
                    className="absolute top-1/6 right-[45.8%] transform w-[10%]"
            ...
            <div className="flex flex-col items-center text-center mb-5">
                <div className="relative w-34 md:w-3/4">
                    <img
                        src={Images.vector5}
                        alt="Purple blob"
                        className=" inset-0"
            ...
            <div className="flex flex-col items-center justify-center text-center mb-5 mt-0 md:mt-24">
                <div className="relative  w-34 md:w-3/4 md:h-2/3">
                    <img
                        src={Images.vector1}
                        alt="Blue blob"
                        className=" inset-0"
                    ...
                    <div className="absolute inset-0 flex  justify-center">
                        ...
                        <img src={Images.vector9} alt='vector9' className='md:w-14 md:h-18 w-10 h-10  mt-10 md:mt-14 lg:mt-18 xxl:mr-10 mr-2 md:mr-8 lg:mr-5' />
                    </div>
