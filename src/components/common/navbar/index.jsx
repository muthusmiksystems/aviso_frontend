...
//               src={Images.Logo}
//               alt="Logo"
//               className="h-10 md:h-[58px] md:w-[220px]"
//             />
//           </NavLink>
//         </div>
...
//                 <NavLink
//                   to={item.path}
//                   className="font-regular text-sm md:text-[16px] text-[#959595] cursor-pointer"
//                 >
//                   {item.name}
//                 </NavLink>
//                 {/* Option 1: Icon */}
...
//                   <div
//                     onMouseLeave={() => setResourceDropdownOpen(false)}
//                     className="absolute left-0 mt-38 w-40 bg-gradient-to-r from-white via-[#F7F8FE] to-[#F0F0FC] shadow-md rounded-md py-2 z-50"
//                   >
...
//                 to={item.path}
//                 className={({ isActive }) =>
//                   `font-regular text-sm md:text-[16px] cursor-pointer ${
//                     isActive ? "text-[#cf36b4] font-bold" : "text-[#959595]"
//                   }`
//                 }
//               >
//                 {item.name}
...
//                 //     onClick={() => setMenuOpen(false)}
//                 //     className={({ isActive }) =>
//                 //       `font-regular text-sm cursor-pointer ${
//                 //         isActive ? "text-[#b82d97] font-bold" : "text-gray-700"
//                 //       }`
//                 //     }
//                 //   >
//                 //     {item.name}
...
//                   <span
//                     key={index}
//                     className="font-regular text-sm md:text-[16px] cursor-pointer text-[#959595] cursor-default"
//                   >
//                     {item.name}
//                   </span>
//                 ) : (
            ...
            item.subMenu ? (
              ...
              >
                ...
                {resourceDropdownOpen && (
                  <div
                    onMouseLeave={() => setResourceDropdownOpen(false)}
                    className="absolute left-0 mt-36 w-40 bg-gradient-to-r from-white via-[#F7F8FE] to-[#F0F0FC] shadow-md rounded-md py-2 z-60"
                  >
                    {item.subMenu.map((subItem, subIndex) => (
                      <NavLink
                        key={subIndex}
